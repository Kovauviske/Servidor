...
if((uiNamespace getVariable["Weapon_Shop_Filter",0]) == 1) then
{
	...
	_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Preço: <t color='#8cff9b'>R$ %1</t></t>",[(_price)] call life_fnc_numberText];
	...
	else
{
	...
	{
		_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Preço: <t color='#ff0000'>R$ %1</t><br/>Falta: <t color='#8cff9b'>R$ %2</t></t>",[(_price)] call life_fnc_numberText,[(_price - life_cash)] call life_fnc_numberText];
	}
		else
	{
		_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Preço: <t color='#8cff9b'>R$ %1</t></t>",[(_price)] call life_fnc_numberText];
